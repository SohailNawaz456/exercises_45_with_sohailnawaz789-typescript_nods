...
let current_users: string[] = ['SoHail', 'DaNiyal', 'SalMan', 'Humzah', 'John'];

let new_users: string[] = ['Bilal', 'SoHail', 'Dawood', 'Jameel', 'Humzah'];

new_users.forEach(new_username =>{
    let toLowerCase: string = new_username.toLowerCase();
